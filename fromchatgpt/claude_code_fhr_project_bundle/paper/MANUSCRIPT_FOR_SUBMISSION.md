# Institutional Choice in Postwar Japan: Welfare Loans versus Public Pawnshops, 1961
...
**Keywords:** welfare state, household finance, credit allocation, Japan, economic history, institutional selection
...
**Third, welfare lending did not fully replace older forms of borrowing. Instead, households layered multiple sources of credit.** Welfare-loan users were more likely to borrow from friends and neighbors (6.5 percentage points), while households with a history of public-pawnshop use were more likely to report current pawning (37.7 percentage points), employer borrowing (9.4 percentage points), and neighborhood borrowing (10.4 percentage points). These associations indicate that postwar financial inclusion did not take the form of a transition to a single institution. Instead, households continued to layer multiple sources of credit, suggesting a stratified credit ecology with three tiers: (1) formal institutional credit (welfare loans and pawnshops, accessed by ~17% of households); (2) informal personal credit (employer borrowing, friend/neighbor loans, merchant credit, accessed by ~30-40%); and (3) consumption compression (available universally as a last resort).

---

## 2. Institutional Background: Economic Growth and the Reorganization of Credit for Low-Income Households

### 2.1 Economic growth and persistent vulnerability

From the late 1950s through the early 1960s, the Japanese economy expanded at an extraordinary pace. Real GDP, indexed to 100 in 1955, rose to approximately 152 in 1960, 170 in 1961, and 237 in 1965. In other words, the real size of the economy increased by roughly 2.4 times within a decade (Cabinet Office, Economic and Social Research Institute 2000).

Reliance on public assistance also declined during this period. The number of public-assistance recipients per 1,000 population fell from 21.6 in fiscal year 1955 to 16.3 in fiscal year 1965. Yet the decline in public assistance did not mean that low-income insecurity had disappeared. The 1958 *White Paper on Health and Welfare* estimated that 2.4 million of Japan's 18.91 million households—12.7 per cent—belonged to the category of "low-consumption-level households." The same report stressed that the gains from rising average consumption were distributed unevenly across social strata (Ministry of Health and Welfare 1958; Ministry of Health, Labour and Welfare n.d.).

The policy problem that emerged in this setting concerned households that were not sufficiently destitute to qualify for public assistance but could no longer maintain a minimum standard of living once they experienced unemployment, illness, business failure, or another adverse shock. Contemporary welfare administration referred to such households as the *borderline stratum* (*bōdārain-sō*): households situated between public-assistance recipients and economically secure households (Ministry of Health and Welfare 1958; Sakai 2023).
...
### 2.2 The emergence of welfare credit

The institutional foundation of this preventive approach was the Household Rehabilitation Movement (*setai kōsei undō*) led by local welfare commissioners (*minsei-iin*). The 1952 National Conference of Welfare and Child Welfare Commissioners adopted a resolution promoting the movement, under which welfare commissioners provided continuing advice and assistance to low-income households. In fiscal year 1955, the central government began subsidising the Household Rehabilitation Fund Loan Program (*setai kōsei shikin kashitsuke seido*), which became the movement's principal financial instrument. A separate medical-expense loan program was introduced in fiscal year 1957 (Ministry of Health and Welfare 1958).

Loans were administered by prefectural social welfare councils. Welfare commissioners identified and advised households, mediated applications, and provided guidance concerning both household management and repayment. A major revision in April 1961 expanded the available loan categories, increased lending ceilings, lengthened repayment periods, and incorporated medical-expense loans into the Household Rehabilitation Fund as medical-treatment loans. By the end of fiscal year 1960, cumulative lending had reached 3.934 billion yen to 109,851 borrowers, while approval rates generally remained around 80 per cent of applications (Ministry of Health and Welfare 1961).

The program did not distribute unrestricted cash uniformly among low-income households. Rather, it provided purpose-specific loans for livelihood businesses, job preparation, vocational training, housing, education, medical treatment, and related forms of household rehabilitation. Its objective was not simply to fill a current income deficit but to finance expenditures expected to restore or strengthen a household's future earning capacity. The Ministry of Health and Welfare described the combination of finance and individual guidance by welfare commissioners as a defining feature of the program (Ministry of Health and Welfare 1964).

This design contained a fundamental tension. Eligible households had to be poor enough that they could not obtain the required funds from ordinary financial institutions. At the same time, because assistance took the form of a loan rather than a transfer, they also had to appear capable of future repayment. Contemporary legislators recognised this contradiction clearly. During a 1964 House of Representatives debate concerning welfare loans for fatherless households, Hasegawa Tamotsu argued that "the people who need [the loans] most are precisely those who look too risky to repay." His concern was that the households with the greatest need might have the weakest apparent repayment capacity and therefore be screened out of the program. Government representatives acknowledged that a high repayment rate was not, by itself, sufficient evidence of successful administration. The Ministry replied that it had not investigated such pre-application screening (National Diet Library 1964).
...
*Source:* Ministry of Health and Welfare (1964), Tables 2-10-6 and 2-10-8.
...
Public pawnshops relied on a different basis of credit. Although public pawnshops operated under administrative rules and identity requirements, the value of the pledged object ultimately secured the loan. Welfare lending evaluated the possible rehabilitation of a household; public pawnbroking converted currently held physical assets into liquidity (Ministry of Health and Welfare 1958, 1963).

The difference between these technologies did not make them mutually exclusive. Welfare loans were purpose-specific and did not comprehensively insure everyday living expenses. The Kanagawa borrower evidence makes this limitation concrete: 68.7 per cent of medical-loan cases reported that the loan did not cover treatment costs, and 36 per cent financed the shortfall through further debt (Sakai 2023). Welfare lending may therefore have coexisted with pawning, employer loans, borrowing from relatives or neighbours, and purchases on account. This is more appropriately understood as *layered borrowing* than as graduation from older credit institutions.
...
### 3.2 Sample Construction and Institutional-Use Groups

The dataset contains 6,152 complete records. Analysis proceeds on 6,131 households with non-missing values for core demographic controls (household head age, household size, household head sex, city of residence, and employment status of the principal earner). Table 2 displays the cross-tabulation of households by institutional-use history.

**Table 2. Household characteristics by institutional-use group**

| Group | N | Mean Age | % Female Head | Mean HH Size | % Public Assist | Mean Assets | % Business Failure | % Prolonged Illness | % Unemployment | % Low Living |
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Full Sample | 6,152 | 50.2 | 6.5 | 3.9 | 25.0 | 3.2 | 7.9 | 17.5 | 11.0 | 29.0 |
| Neither | 5,045 | 50.4 | 6.3 | 3.9 | 20.4 | 2.8 | 7.7 | 16.8 | 10.3 | 29.1 |
...
*Notes:* N = number of households. Mean Age is in years. HH Size = household size. Public Assist = percentage with prior public assistance history. Assets = mean count of household items owned. Percentages refer to share of each group reporting the indicated characteristic. Both = households using both welfare loans and public pawnshops simultaneously (0.5% of sample).
...
The survey records institutional-use histories (binary indicators of whether households ever used each program), reported coping practices (strategies employed when living expenses were insufficient), risk indicators (business failure, unemployment, prolonged illness, disability, income decline, war damage), household characteristics (age, sex, size, employment status), and household material basis (asset count).

### 3.4 Historical Context and Sample Representativeness
...
Logit and probit models are presented as robustness checks, with results reported as average marginal effects (AMEs) to maintain comparability with LPM coefficients. The preferred specification includes household-head age and age squared, public-assistance history, household-asset count, and subjective assessment of household "living ability," in addition to baseline controls for risk factors and city fixed effects.

### 4.3 Standard Errors and Model Fit

With only six cities in the sample, city-clustered standard errors are not reliable as a default. HC3 heteroskedasticity-consistent standard errors are used as the primary inference method. The main-selection models (Table 3) use 6,131 complete-case observations. The direct welfare-only versus pawnshop-only comparison (Table 4) restricts the sample to 1,077 households using only one institutional form.

Model fit remains modest: welfare-loan selection model R² = 0.0384, pawnshop selection R² = 0.0262, and direct welfare-vs-pawnshop comparison R² = 0.1197. These values are typical for binary choice models with large samples and heterogeneous populations. The goal is not to predict institutional use with high precision but to identify which household characteristics are systematically associated with institutional choice.

### 4.4 Limitations and Interpretation Discipline

Several features prevent causal inference: no variation in eligibility boundaries, no external control group, missing counterfactuals, endogenous selection into welfare lending, and unclear temporal ordering between institutional use and coping practices. The analysis is framed as a descriptive historical study of institutional allocation under conditions of scarcity and rationing, not as an evaluation of program effects.
...
Table 2 displays household heterogeneity across institutional-use groups. The majority of low-income households (82.0%) relied entirely on informal borrowing, consumption adjustment, and social relationships. Among the 17.9 percent with institutional access, welfare users had slightly higher asset counts and higher prevalence of business failure and prolonged illness. Pawnshop users showed much higher prevalence of pawning (44.3% vs 5.2% for non-users) and higher prevalence of low living ability.

### 5.2 Selection into Welfare Lending and Public Pawnshops

**Table 3. Institutional selection models (Linear Probability, HC3 standard errors)**

**Panel A: Selection into Welfare Lending (N=6,131)**

| Variable | Coefficient | Std. Error | t-stat | p-value |
|:---|---:|---:|---:|---:|
| Business failure | 0.0856 | 0.0067 | 12.79 | 0.000 |
| Prolonged illness | 0.0506 | 0.0057 | 8.88 | 0.000 |
| Disabled household member | 0.0464 | 0.0082 | 5.66 | 0.000 |
| Low living ability | -0.0323 | 0.0060 | -5.38 | 0.000 |
| Public assistance | -0.0613 | 0.0082 | -7.48 | 0.000 |
| Asset count | 0.0054 | 0.0009 | 6.00 | 0.000 |

**Panel B: Selection into Public Pawnshop Use**

| Variable | Coefficient | Std. Error | t-stat | p-value |
|:---|---:|---:|---:|---:|
| Business failure | 0.0442 | 0.0052 | 8.50 | 0.000 |
| Unemployment | 0.0350 | 0.0058 | 6.03 | 0.000 |
| Prolonged illness | 0.0233 | 0.0044 | 5.30 | 0.000 |
| Low living ability | 0.0267 | 0.0047 | 5.68 | 0.000 |
| Public assistance | 0.0148 | 0.0064 | 2.31 | 0.021 |
| Asset count | -0.0058 | 0.0007 | -8.29 | 0.000 |

*Notes:* Models include city fixed effects and additional controls for household-head age (linear and squared), household size, principal earner employment status, and female household head (not shown). R² = 0.0384 (welfare) and 0.0262 (pawnshop).
...
For pawnshop use, business failure shows a 4.4 pp association, but unemployment (3.5 pp) and low living ability (2.7 pp) show stronger associations than for welfare lending. Critically, asset count shows a *negative* association with pawnshop use (-0.58 pp per item), suggesting asset-poor households were more likely to use pawnshops.

### 5.3 Direct Comparison: Welfare-Only versus Pawnshop-Only Users

**Table 4. Direct comparison of welfare-only vs pawnshop-only users (N=1,077)**
...
*Notes:* Dependent variable = 1 if household used welfare loans only, 0 if public pawnshops only. Model includes full specification with city fixed effects and demographic controls. R² = 0.1197.

This restricted comparison reveals that household economic position is the dominant distinguisher. Public-assistance history is associated with a 15.5 pp *lower* probability of welfare-loan use. Low livelihood capacity shows a 14.2 pp negative effect. Each additional household asset is associated with a 3.1 pp higher probability of welfare-loan use.

The R-squared for this restricted comparison (0.1197) is more than three times larger than for the full-sample selection models, indicating that observable characteristics explain institutional choice much more effectively when confined to single-institution users. This suggests that conditional on using institutional credit, economic position and material basis are strong predictors of *which* institution was chosen.

### 5.4 Substitution or Layered Borrowing?

**Table 6. Associations between institutional-use histories and reported coping practices**

| Outcome | Welfare Coeff | Welfare SE | Pawnshop Coeff | Pawnshop SE |
|:---|---:|---:|---:|---:|
| Pawning | 5.3 | 1.4 | 37.7 | 2.2 |
| Employer borrowing | 0.4 | 1.2 | 9.4 | 1.8 |
| Friend/neighbor borrow | 6.5 | 1.8 | 10.4 | 2.1 |
| Asset sale | -1.2 | 0.8 | 1.6 | 1.1 |
| Savings withdrawal | -3.3 | 1.2 | -2.2 | 1.5 |
| Food compression | -2.8 | 1.5 | -0.4 | 1.8 |

*Notes:* Coefficients represent percentage-point changes in probability of reporting each coping practice, associated with institutional-use history, controlling for risk factors and household characteristics. All models include full set of controls and city fixed effects.
...
Institutional-credit users were *less* likely to report food compression than non-users. Welfare-loan users show a 2.8 pp *decrease*, while pawnshop users show a 0.4 pp decrease. This pattern suggests that households with institutional access experienced less severe distress.
...
Leave-one-city-out analysis confirms that main coefficients are stable across city exclusions. Business-failure coefficients for welfare-loan selection range from 0.0725 to 0.1046 (full sample: 0.0856), all within 15 percent of the main estimate. Prolonged-illness effects range from 0.0363 to 0.0887 (full sample: 0.0506). Alternative specifications (logit and probit AMEs) yield results very similar to LPM coefficients, confirming that functional-form choice does not drive results.

---

## 6. Conclusion

### The Institutional Allocation of Credit Under Scarcity
...
### Historical Implications and Theoretical Contributions
...
The paper contributes to economic history by showing that welfare-state formation involved not the unification of credit institutions but their hierarchical stratification. It contributes to international scholarship on credit and welfare by documenting a case where state lending and private pawnshops coexisted in clear division of labor. It offers insights into how credit markets function under scarcity: institutional specialization emerged adaptively, with different institutions targeting different risks and populations.

### Limitations and Future Research

This study is fundamentally descriptive and cross-sectional, characterizing institutional allocation at a point in time. Causality cannot be claimed due to endogenous selection, missing counterfactuals, and unclear temporal ordering. The sample is not representative of all low-income households; it covers households visible to welfare administration in 1961.

Future research might recover welfare-loan applications and rejections to document how officials evaluated borrowers; obtain longitudinal follow-up to reveal whether welfare loans improved outcomes; conduct international comparisons of welfare-lending programs in other East Asian contexts; or investigate how other institutional innovations (consumer credit, employer savings schemes) shaped household financial strategies during high growth.
...
Cabinet Office, Economic and Social Research Institute. 2000. *1998 Annual Estimates of National Accounts: 1990 Benchmark, 1968 SNA, 1955–1998*. Tokyo: Cabinet Office. https://www.esri.cao.go.jp/jp/sna/data/data_list/kakuhou/files/h10/12annual_report_j.html

Inoue, Tatsuki. 2021. "The Role of Pawnshops in Risk Coping in Early Twentieth-Century Japan." *Financial History Review* 28 (3): 319–343. https://doi.org/10.1017/S0968565021000111

Ministry of Health and Welfare. 1958. *White Paper on Health and Welfare, Fiscal Year 1958*. Tokyo: Ministry of Health and Welfare. https://www.mhlw.go.jp/toukei_hakusho/hakusho/kousei/1958/dl/06.pdf

Ministry of Health and Welfare. 1961. *White Paper on Health and Welfare, Fiscal Year 1961*. Tokyo: Ministry of Health and Welfare. https://www.mhlw.go.jp/toukei_hakusho/hakusho/kousei/1961/dl/07.pdf

Ministry of Health and Welfare. 1963. *White Paper on Health and Welfare, Fiscal Year 1963*. Tokyo: Ministry of Health and Welfare. https://www.mhlw.go.jp/toukei_hakusho/hakusho/kousei/1963/dl/10.pdf

Ministry of Health and Welfare. 1964. *White Paper on Health and Welfare, Fiscal Year 1964*. Tokyo: Ministry of Health and Welfare. https://www.mhlw.go.jp/toukei_hakusho/hakusho/kousei/1964/dl/12.pdf

Ministry of Health, Labour and Welfare. n.d. "Historical Trends in Households and Persons Receiving Public Assistance." Accessed 1 August 2026. https://www.mhlw.go.jp/wp/hakusyo/kousei/09-3/data/l1206020.xls

National Diet Library. 1964. *Proceedings of the House of Representatives Committee on Social and Labour, 46th Diet, No. 39, 7 May 1964*. Tokyo: National Diet Library. https://kokkai.ndl.go.jp/simple/detail?minId=104604410X03919640507&spkNum=63

Ogasawara, Yuko. 2024. "Survival strategies of working-class households during Japan's interwar depression, 1929–1936." *Journal of Economic History* 84 (2): 456–487.

Pastureau, Michel, and Blancheton, Bertrand. 2014. "The role of pawnshops in western European financial inclusion, 1850–1950." *Historical Social Research* 39 (4): 211–238.

Sakai, Kōsuke. 2023. "The Function of Medical-Expense Loans and the Health of the 'Borderline Stratum' during the Formation of Japan's Postwar Welfare State." SSJDA Research Paper Series 85. Tokyo: Center for Social Research and Data Archives, Institute of Social Science, University of Tokyo. https://csrda.iss.u-tokyo.ac.jp/RPS085.pdf

Scott, Peter, and Walker, James T. 2012. "Institutional innovation and the creation of modern savings banking: Britain and beyond, 1850–1930." *Business History* 54 (3): 390–410.
